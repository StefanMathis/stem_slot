...
[`Slot`]: https://docs.rs/stem_slot/0.3.3/stem_slot/slot/trait.Slot.html
[`Slot::current_displacement_coefficients]: https://docs.rs/stem_slot/0.3.3/stem_slot/slot/trait.Slot.html#tymethod.current_displacement_coefficients
[`Slot::leakage_coefficient_opening]: https://docs.rs/stem_slot/0.3.3/stem_slot/slot/trait.Slot.html#tymethod.leakage_coefficient_opening
[`RectangularSlot`]: https://docs.rs/stem_slot/0.3.3/stem_slot/rectangular/struct.RectangularSlot.html
[`OpenTrapezoidSlot`]: https://docs.rs/stem_slot/0.3.3/stem_slot/open_trapezoid/struct.OpenTrapezoidSlot.html
[`SemiTrapezoidSlot`]: https://docs.rs/stem_slot/0.3.3/stem_slot/semi_trapezoid/struct.SemiTrapezoidSlot.html
[`Slot::leakage_coefficient_opening`]: https://docs.rs/stem_slot/0.3.3/stem_slot/slot/trait.Slot.html#method.leakage_coefficient_opening
[`Slot::current_displacement_coefficients`]: https://docs.rs/stem_slot/0.3.3/stem_slot/slot/trait.Slot.html#method.current_displacement_coefficients
...
The full API documentation is available at <https://docs.rs/stem_slot/0.3.3/stem_slot>.
